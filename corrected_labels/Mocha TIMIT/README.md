Ground-truth voicing labels for the Mocha TIMIT dataset derived from laryngograph recordings employing the label generation method outlined in Section IV-C.
